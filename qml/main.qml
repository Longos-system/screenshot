...
Item {
    ...
    function refreshImage() {
        image.source = ""
        image.source = "file:///tmp/long-screenshot.png"

        selectImage.source = ""
        selectImage.source = "file:///tmp/long-screenshot.png"
    }
    ...
    Rectangle {
        ...
        width: sizeLabel.implicitWidth + LongUI.Units.largeSpacing
        height: sizeLabel.implicitHeight + LongUI.Units.largeSpacing

        z: 999
        x: selectLayer.x
        y: {
            var newY = selectLayer.y - sizeToolTip.height - LongUI.Units.smallSpacing
        ...
        color: Qt.rgba(LongUI.Theme.backgroundColor.r,
                       LongUI.Theme.backgroundColor.g,
                       LongUI.Theme.backgroundColor.b, 0.9)
        border.width: 1
        border.color: Qt.rgba(LongUI.Theme.textColor.r,
                               LongUI.Theme.textColor.g,
                               LongUI.Theme.textColor.b, 0.15)
    ...
    Rectangle {
        ...
        width: toolsLayout.implicitWidth + LongUI.Units.largeSpacing
        height: 36 + LongUI.Units.smallSpacing
...
//                newY = control.height - tools.height
            ...
            // 选中区域与工具栏高度大于总高度
            if (selectLayer.y + selectLayer.height + tools.height + LongUI.Units.smallSpacing >= control.height) {
                newY = selectLayer.y - tools.height - LongUI.Units.smallSpacing
            } else {
                newY = selectLayer.y + selectLayer.height + LongUI.Units.smallSpacing
            }
        ...
        RowLayout {
            ...
            anchors.bottomMargin: LongUI.Units.smallSpacing / 2
